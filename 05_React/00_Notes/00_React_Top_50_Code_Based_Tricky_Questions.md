...
**Answer: B) Name changed: Alice, Bob, Alice, Bob**

**Explanation:**

1. Component mounts          → name = 'Alice' → "Name changed: Alice"
2. Click "Change"            → name = 'Bob'   → "Name changed: Bob"
3. Click "Reset"             → name = 'Alice' → "Name changed: Alice"
4. Click "Change"            → name = 'Bob'   → "Name changed: Bob"

Total: 4 logs (Alice, Bob, Alice, Bob)
...
- Initial: items = [1, 2, 3]
- Effect runs initially? Yes
- Click Add: items = [1, 2, 3, 4] → effect runs → logs (1)
- Click Add: items = [1, 2, 3, 4, 5] → effect runs → logs (2)

Wait, that's 3. Let me check strict mode again:

**Answer: Depends on strict mode. Without: 3 times. With: 4 times
...
**Answer: A) "Memoizing" three times**
...
**Answer: A) "Memoizing" once initial + twice from clicks = 3 times total**
...
- **Answer: B) Sync shows 1, Async shows 2 - React 17** 
- **Answer: A) Both shows 1 - After React 18**

**Explanation for React 17:**
